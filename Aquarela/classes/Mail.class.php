<?php
	...
	class Mail{
		...
		public $opt,$mailer;
		public $email = 'ceaf@aquareladafreguesia.com';//Trocar e-mail aqui!
		public $senha = 'Aquarela12#';//Trocar senha aqui!
		...
		public function __construct(Array $parametros){
			...
			$this->mailer->IsSMTP();
			$this->mailer->Host = 'mail.aquareladafreguesia.com'; //SERVIDOR SMTP DA HOSPEDAGEM
